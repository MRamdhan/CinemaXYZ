...
<body>
    ...
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('postEditMovie', $movie->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-container">
                        <div class="form-group">
                            <label for="name" class="form-label">Nama Film</label>
                            <input type="text" id="name" name="name" class="form-control" value="{{ $movie->name }}" placeholder="Masukkan nama film">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="genre_id" name="genre_id" class="form-select">
                                @foreach ($genre as $item)
                                    <option value="{{ $item->id }}" {{ $item->id == $movie->genre_id ? 'selected' : '' }}>
                                        {{ $item->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="minutes" name="minutes" class="form-control" value="{{ $movie->minutes }}" placeholder="Masukkan durasi film">
                        </div>

                        <div class="form-group">
                            <label for="director" class="form-label">Sutradara</label>
                            <input type="text" id="director" name="director" class="form-control" value="{{ $movie->director }}" placeholder="Masukkan nama sutradara">
                        </div>

                        <div class="form-group">
                            <label for="studio_name" class="form-label">Studio</label>
                            <input type="text" id="studio_name" name="studio_name" class="form-control" value="{{ $movie->studio_name }}" placeholder="Masukkan nama studio">
                        </div>

                        <div class="form-group">
                            <label for="studio_capacity" class="form-label">Kapasitas Studio</label>
                            <input type="number" id="studio_capacity" name="studio_capacity" class="form-control" value="{{ $movie->studio_capacity }}" placeholder="Masukkan kapasitas studio">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <img id="preview" src="{{ asset('storage/' . $movie->image) }}" alt="Preview Image">
                        </div>
                    ...
                    <div class="text-center mt-4">
                        <button type="submit" class="btn btn-info px-4">Edit Data</button>
